...
import belldial.co.uk.settings.widget.BasicSetting;
import belldial.co.uk.settings.widget.ListSetting;
import belldial.co.uk.settings.widget.SettingListenerBase;
import belldial.co.uk.settings.widget.SwitchSetting;
import belldial.co.uk.settings.widget.TextSetting;
...
public class AccountSettingsFragment extends SettingsFragment {
        ...
        mDisable.setListener(
                new SettingListenerBase() {
                    ...
                    public void onBoolValueChanged(boolean newValue) {
                        if (mProxyConfig != null) {
                            mProxyConfig.edit();
                            mProxyConfig.setRegisterEnabled(!newValue);
                            mProxyConfig.done();
                        } else {
                            Log.e("[Account Settings] No proxy config !");
                        }
                ...
                new SettingListenerBase() {
                    ...
                    public void onBoolValueChanged(boolean newValue) {
                        if (mProxyConfig != null) {
                            ...
                            if (natPolicy != null) {
                                natPolicy.setIceEnabled(newValue);
                                if (newValue) natPolicy.setStunEnabled(true);
                            }
                            mProxyConfig.done();
                        } else {
                            Log.e("[Account Settings] No proxy config !");
                ...
                new SettingListenerBase() {
                    ...
                    public void onBoolValueChanged(boolean newValue) {
                        if (mProxyConfig != null) {
                            ...
                            mAvpfInterval.setEnabled(mProxyConfig.getAvpfMode() == AVPFMode.Enabled);
                            mProxyConfig.done();
                        } else {
                            Log.e("[Account Settings] No proxy config !");
                        }
    ...
    private void updateValues() {
        ...
        if (mProxyConfig != null) {
            ...
            mDisable.setChecked(!mProxyConfig.isRegisterEnabled());
            ...
            mIce.setChecked(natPolicy.isIceEnabled());
            mIce.setEnabled(
                    natPolicy.getStunServer() != null && !natPolicy.getStunServer().isEmpty());

            mAvpf.setChecked(mProxyConfig.getAvpfMode() == AVPFMode.Enabled);
