...
public final class LinphoneUtils {
    ...
    public static boolean isNumberAddress(String numberOrAddress) {
        ...
        return account.normalizePhoneNumber(numberOrAddress) != null;
    }
    ...
    public static String timestampToHumanDateNew(Context context, long timestamp, String format) {
        try {
            Calendar cal = Calendar.getInstance();
            cal.setTimeInMillis(timestamp * 1000); // Core returns timestamps in seconds...
    ...
    public static String getDisplayableUsernameFromAddress(String sipAddress) {
        ...
        if (username.contains("@")) {
            ...
            if (lpc != null) {
                if (domain.equals(lpc.getParams().getDomain())) {
    ...
    public static String getFullAddressFromUsername(String username) {
        ...
        if (!sipAddress.contains("@")) {
            Account lpc = core.getDefaultAccount();
            if (lpc != null) {
                sipAddress = sipAddress + "@" + lpc.getParams().getDomain();
            } else {
                sipAddress =
                        sipAddress
                                + "@"
