...
public class FileUtils {
    ...
    public static Uri getCVSPathFromLookupUri(Context context, String content) {
        ...
        for (FriendList list : friendList) {
            for (Friend friend : list.getFriends()) {
                if (friend.getRefKey().equals(contactId)) {
                    ...
                    return createCvsFromString(context, contactVcard);
                }
            }
        }
        return null;
    ...
    public static String getStorageDirectory(Context mContext) {
        String storageDir = mContext.getFilesDir().toString();
    ...
    public static String getRecordingsDirectory(Context mContext) {
        String recordingsDir = mContext.getFilesDir() + "/recordings";
    ...
    private static Uri createCvsFromString(Context context, String vcardString) {
        String contactName = getContactNameFromVcard(vcardString);
        File vcfFile = new File(context.getFilesDir(), contactName + ".cvs");
        try {
