...
import belldial.co.uk.receivers.BluetoothReceiver;
import belldial.co.uk.receivers.HeadsetReceiver;
...
public class AndroidAudioManager {
    ...
    private synchronized void startRinging(Address remoteAddress) {
        ...
        boolean doNotDisturbPolicyAllowsRinging = Compatibility.isDoNotDisturbPolicyAllowingRinging(mContext,
                remoteAddress);
        ...
        try {
            ...
            if (mRingerPlayer == null) {
                ...
                String ringtone = LinphonePreferences.instance()
    ...
    private synchronized void changeBluetoothSco(final boolean enable) {
        // IT WILL TAKE A CERTAIN NUMBER OF CALLS TO EITHER START/STOP BLUETOOTH SCO FOR
        // IT TO WORK
                    ...
                    public void onServiceConnected(int profile, BluetoothProfile proxy) {
                        if (profile == BluetoothProfile.HEADSET) {
                            ...
                            if (ActivityCompat.checkSelfPermission(mContext,
                                ...
                                Toast.makeText(mContext, "Allow BLUETOOTH Connect Permission", Toast.LENGTH_SHORT)
                                        .show();
                                return;
                            }
                            ...
                            Intent sticky = mContext.registerReceiver(mBluetoothReceiver, filter);
                            int state = sticky.getIntExtra(
