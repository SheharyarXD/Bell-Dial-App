...
public class RecentCallsAdapter extends RecyclerView.Adapter<RecentCallsAdapter.ViewHolder> {
    ...
    public RecentCallsAdapter(Context context, List<CallLog> mLogs, ItemListener itemListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v =
                LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.row_recent_call_item, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (log.getDir() == Call.Dir.Incoming) {
            ...
            if (log.getStatus() == Call.Status.Missed || log.getDuration() == 0) {
            ...
            holder.textViewCallType.setText("Outbound Call");
        }
