package belldial.co.uk.purchase;
...
import belldial.co.uk.purchase.IInAppBillingService;
...
import belldial.co.uk.xmlrpc.XmlRpcHelper;
import belldial.co.uk.xmlrpc.XmlRpcListenerBase;
...
class InAppPurchaseHelper {
    ...
    public InAppPurchaseHelper(Activity context, InAppPurchaseListener listener) {
        ...
        Intent serviceIntent = new Intent("belldial.co.uk.billing.InAppBillingService.BIND");
