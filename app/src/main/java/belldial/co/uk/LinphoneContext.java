...
import belldial.co.uk.notifications.NotificationsManager;
                    ...
                    public void onCallStateChanged(
                        ...
                        if (state == Call.State.IncomingReceived
                            ...
                            if (sharedPreferences.getBoolean(Constant.IS_LOGIN, false)) {
                                // Starting SDK 24 (Android 7.0) we rely on the fullscreen intent of
                                // the
                                ...
                                call.decline(Reason.TemporarilyUnavailable);
                            }
                            ...
                            if (call.getDir() == Call.Dir.Incoming && call.getDuration() == 0) {
...
//        Log.i("SDK BRANCH=" + mContext.getString(R.string.linphone_sdk_branch));
    ...
    private void onIncomingReceived() {
        ...
        intent.putExtra("from", "LinphoneContext");
