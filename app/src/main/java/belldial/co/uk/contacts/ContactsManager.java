...
public class ContactsManager extends ContentObserver implements FriendListListener {
    ...
    public static ContactsManager getInstance() {
        ...
        return LinphoneContext.instance() == null ? null : LinphoneContext.instance().getContactsManager();
    }
    ...
    public boolean hasReadContactsAccess() {
        ...
        boolean contactsR =  PackageManager.PERMISSION_GRANTED == mContext.checkSelfPermission(Manifest.permission.READ_CONTACTS);
        return contactsR
    ...
    private Executor asyncThread = Executors.newCachedThreadPool();
    ...
    public void initializeSyncAccount() {
