package belldial.co.uk.contacts;
...
import org.linphone.core.ChatRoom.Backend;
...
import belldial.co.uk.utils.SimpleChatRoomListener;
...
public class ContactDetailsFragment extends Fragment implements ContactsUpdatedListener {
    ...
    public View onCreateView(
        ...
        deleteContact.setOnClickListener(
                new OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        final Dialog dialog = ((ContactsActivity) getActivity())
        ...
        mChatRoomCreationListener = new SimpleChatRoomListener() {
            @Override
    ...
    public void onContactsUpdated() {
        LinphoneContact contact = ContactsManager.getInstance().findContactFromAndroidId(mContact.getAndroidId());
        if (contact != null) {
    ...
    private void displayContact(LayoutInflater inflater, View view) {
        ...
        for (LinphoneNumberOrAddress noa : mContact.getNumbersOrAddresses()) {
            ...
            Account lpc = LinphoneManager.getCore().getDefaultAccount();
            if (lpc != null) {
                        ...
                        .setOnClickListener(
                                new OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        String text = getString(R.string.invite_friend_text)
                                                .replace(
                                                        "%s",
            ...
            if (v.findViewById(R.id.friendLinphone).getVisibility() == View.VISIBLE
                    && mContact.hasPresenceModelForUriOrTelCapability(
                            noa.getValue(), Friend.Capability.LimeX3Dh)) {
    ...
    private void goToChat(String tag, boolean isSecured) {
        ...
        if (defaultAccount != null) {
            ...
            if (room != null) {
                ...
                if (defaultAccount.getParams().getConferenceFactoryUri() != null
                        && (isSecured
