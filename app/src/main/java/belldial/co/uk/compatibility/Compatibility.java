...
public class Compatibility {
    ...
    public static String getDeviceName(Context context) {
        try {
            ...
            Log.d("asad", "getDeviceName: " + e.getMessage());
            return null;
    ...
    public static Notification createMissedCallNotification(
        ...
        if (Version.sdkAboveOrEqual(Version.API26_O_80)) {
            ...
            return ApiTwentyFourPlus.createMissedCallNotification(context, title, text, intent);
        }
    ...
    public static Notification createIncomingCallNotification(Context context, int callId,
            Bitmap contactIcon,
            String contactName,
            String sipUri,
            PendingIntent intent) {
