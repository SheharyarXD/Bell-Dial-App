...
class SideMenuAccountsListAdapter extends BaseAdapter {
    ...
    private List<Account> proxy_list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        View view;
        Account lpc = (Account) getItem(position);
        if (convertView != null) {
            view = convertView;
        } else {
            view =
        ...
        String sipAddress = lpc.getParams().getIdentityAddress().asStringUriOnly();
