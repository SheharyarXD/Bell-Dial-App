...
import belldial.co.uk.views.AddressText;
import belldial.co.uk.views.CallButton;
import belldial.co.uk.views.Digit;
import belldial.co.uk.views.EraseButton;
...
public class DialerActivity extends MainActivity implements AddressText.AddressChangedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Uses the fragment container layout to inflate the dialer view instead of
        // using a fragment
        ...
        if (ACTION_CALL_LINPHONE.equals(action)
            ...
            if (uri != null) {
                ...
                if (Intent.ACTION_CALL.equals(action)) {
                    ...
                    addressToCall = ContactsManager.getInstance()
