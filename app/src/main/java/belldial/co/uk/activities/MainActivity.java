...
import belldial.co.uk.call.CallActivity;
import belldial.co.uk.call.CallIncomingActivity;
import belldial.co.uk.call.CallOutgoingActivity;
...
import belldial.co.uk.fragments.EmptyFragment;
import belldial.co.uk.fragments.StatusBarFragment;
import belldial.co.uk.history.HistoryActivity;
import belldial.co.uk.menu.SideMenuFragment;
...
public abstract class MainActivity extends LinphoneGenericActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStatusBarFragment = (StatusBarFragment) getFragmentManager().findFragmentById(R.id.status_fragment);

        DrawerLayout mSideMenu = findViewById(R.id.side_menu);
        RelativeLayout mSideMenuContent = findViewById(R.id.side_menu_content);
        mSideMenuFragment = (SideMenuFragment) getSupportFragmentManager().findFragmentById(R.id.side_menu_fragment);
            ...
            public void onAccountRegistrationStateChanged(
                ...
                if (state == RegistrationState.Ok) {
                    ...
                    if (getResources().getBoolean(R.bool.use_phone_number_validation)) {
                        AuthInfo authInfo = core.findAuthInfo(
                                account.getParams().getRealm(),
                                account.getParams().getIdentityAddress().getUsername(),
                                account.getParams().getDomain());
                        if (authInfo != null
                                && authInfo.getDomain()
    ...
    protected void onStart() {
        ...
        // android.util.Log.d("khan", "onStart: ");
    ...
    private void displayDNDSettingsDialog() {
        ...
        final Dialog dialog = displayDialog(getString(R.string.pref_grant_read_dnd_settings_permission_desc));
