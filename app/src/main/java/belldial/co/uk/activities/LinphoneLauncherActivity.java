...
import belldial.co.uk.utils.ServiceWaitThread;
import belldial.co.uk.utils.ServiceWaitThreadListener;
...
public class LinphoneLauncherActivity extends Activity implements ServiceWaitThreadListener {
    ...
    protected void onStart() {
        ...
        if (LinphoneService.isReady()) {
            ...
            startService(new Intent().setClass(LinphoneLauncherActivity.this, LinphoneService.class));
