...
import belldial.co.uk.ui.activity.SplashActivity;
import belldial.co.uk.utils.ActivityMonitor;
import belldial.co.uk.views.LinphoneGL2JNIViewOverlay;
import belldial.co.uk.views.LinphoneOverlay;
import belldial.co.uk.views.LinphoneTextureViewOverlay;
...
public final class LinphoneService extends Service {
    ...
    public void onCreate() {
        ...
        try {
            ...
            android.util.Log.d("asad", "onCreate: "+e.getMessage());
        }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Log.i("[Service] Started");
            ...
            e.printStackTrace();
            android.util.Log.d("asad", "onStartCommand: "+e.getMessage());
        }
        return START_STICKY;
    }
